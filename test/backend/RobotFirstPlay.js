...
import { findBestPlay } from "../../js/backend/findBestPlay.js";
 ...
 */
describe("backend/RobotFirstPlay", () => {

  it("first play English Scrabble", () => {
    let bestPlay;

    let game = new BackendGame({
  ...
  it("first play English WWF", () => {
    ...
    let game = new BackendGame({edition:"English_WWF", dictionary:"Oxford_5000"});
    return game.create()
    .then(() => game.onLoad(new MemoryDatabase()))
    .then(game => {
      game.addPlayer(
