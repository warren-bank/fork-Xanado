define("game/edition/Nederlands_Scrabble", ["game/ScrabbleEdition"], (ScrabbleEdition) => {
	...
	class Nederlands_Scrabble extends ScrabbleEdition {
		constructor() {
			super(BAG);
		}
	}
	return Nederlands_Scrabble;
});
