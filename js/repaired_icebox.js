...
define("icebox", () => {
	...
	class Icebox {
		...
		static thaw(object, prototypeMap) {
			var objectsThawed = [];
				...
				if (object && (typeof object == 'object')) {
					if (object._icebox_ref !== undefined) {
						if (objectsThawed[object._icebox_ref]) {
							...
							throw Error(`Icebox: invalid reference to id ${object._icebox_ref}`);
						}
					} else {
						var thawed;
		...
		static freeze(object, objectFreezeHandler) {
			var objectsFrozen = [];
			var id = 0;
				...
				if (object && (typeof object == 'object')) {
					if (object._icebox_frozen) {
						...
						if (object.constructor && object.constructor.name
							&& !object.constructor.name.match(/^(Array|Object)$/)) {
