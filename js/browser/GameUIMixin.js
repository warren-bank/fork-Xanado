...
define([
   ...
   */
  return superclass => class GameUIMixin extends superclass {
    ...
    sendCommand(command, args) {
      assert.fail("GameUIMixin.sendCommand");
    }
     ...
     */
    getSetting(key) {
      assert.fail("GameUIMixin.getSetting");
    }
     ...
     */
    getDictionary(name) {
      assert.fail("GameUIMixin.getDictionary");
    }
     ...
     */
    getEdition(ed) {
      assert.fail("GameUIMixin.getEdition");
    }
