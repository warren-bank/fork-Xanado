...
import { findBestPlay as fbRaw } from "../../js/backend/findBestPlay.js";
import { findBestPlay as fbWorker } from "../../js/backend/findBestPlayController.js";
...
describe("backend/findBestPlay", () => {
  ...
  function blanks(findBestPlay) {
    ...
    .then(game => {
      game.addPlayer(new Player({
        name:"test", key:"creep", isRobot:true}, BackendGame.CLASSES), true);
  ...
  function noe(findBestPlay) {
    let bestMoves = [];
    let rack = new Rack(BackendGame.CLASSES, { id: "best", size: 7 });
    ...
    .then(game => {
      game.addPlayer(new Player(
        {name:"test", key:"slime", isRobot:true}, BackendGame.CLASSES), true);
      return game.loadBoard(
        "| | | | | | | | | | | | | | | |\n" +
        "| | | | | | | | | | | | | | | |\n" +
        "| | | | | | | | | | | | | | | |\n" +
  ...
  it("town", () => {
    let bestMoves = [];
    const rack = new Rack(BackendGame.CLASSES, { id: "best", size: 7 });
    ...
    .then(game => {
      game.addPlayer(new Player(
        {name:"test", key:"crisp", isRobot:true}, BackendGame.CLASSES), true);
      return game.loadBoard(
        "| | | | | | | | | | | | | | | |\n" +
        "| | | | | | | | | | | | | | | |\n" +
        "| | | | | | | | | | | | | | | |\n" +
